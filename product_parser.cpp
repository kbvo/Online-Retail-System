...
{
    return new Clothing(categoryID(), prodName_, size_, brand_, price_, qty_);
}
...
/**
 * Create a new movie product
 * using the data members in this class and the parent ProductParser class
 */
Product* ProductMovieParser::makeProduct()
{
    return new Movie(categoryID(), prodName_, genre_, rating_, price_, qty_);
}
